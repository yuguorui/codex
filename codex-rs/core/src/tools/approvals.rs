...
impl ApprovalResolution {
    ...
    fn into_extension_outcome(self) -> ToolApprovalOutcome {
        ...
        match self.decision {
            ...
            ReviewDecision::TimedOut => ToolApprovalOutcome::TimedOut {
                rejection: truncate_extension_rejection(&guardian_timeout_message()),
            },
...
impl Session {
    ...
    pub(crate) async fn request_extension_tool_user_approval(
        ...
        resolution.into_extension_outcome()
    }
