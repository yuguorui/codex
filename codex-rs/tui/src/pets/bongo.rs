...
///
/// The art is 32 columns wide; on narrower terminals the reserved layout space
/// crowds the conversation, so we stop drawing (and stop reserving space) there.
pub(super) const MIN_BONGO_TERMINAL_WIDTH: u16 = 40;
