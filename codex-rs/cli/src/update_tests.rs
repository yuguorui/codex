...
fn validate_release_checks_package_metadata_and_layout() {
    ...
    validate_release(release_dir, "202608310535", "x86_64-unknown-linux-musl")
        .expect("package should validate");
    assert!(
        validate_release(release_dir, "202608310536", "x86_64-unknown-linux-musl").is_err(),
