...
agent index. Owning-model orchestration tools remain with the owning agent.
...
- `stallMs`: optional no-progress timeout. Use it to match the expected duration of meaningful work.
