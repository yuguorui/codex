...
impl WorkflowService {
    ...
    pub fn retry_agent(
        ...
        Ok(task.control.rerun_from(agent_index))
    }
    ...
    async fn finish_task(
        ...
        self.event_sink.emit(Event {
            ...
            msg: EventMsg::WorkflowCompleted(completed_event.clone()),
        });
        self.notify_owning_thread(&completed_event).await;
    ...
    async fn notify_owning_thread(&self, event: &WorkflowCompletedEvent) {
        ...
        thread
            .inject_user_message_without_turn(codex_core::format_workflow_notification_message(
                event,
            ))
            .await;
    }
