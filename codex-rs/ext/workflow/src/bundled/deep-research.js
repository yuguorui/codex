...
const SEARCH_PROMPT = (angle) =>
  ...
  "## Task\nUse the available web search tool with the query above (or a refined version). Return the top 4-6 most relevant results.\n" +
...
const FETCH_PROMPT = (source, angle) =>
  ...
  "## Task\n1. Use available web tools to open or retrieve the page content.\n" +
